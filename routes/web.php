...
Route::get('/tentangkami','frontController@tentangkami');
Route::get('/pedoman','frontController@pedoman');
Route::get('/manajemen','frontController@manajemen');
Route::get('/ketentuan','frontController@ketentuan');
